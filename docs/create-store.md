...
an environment variable for you to utilize - `STORE_OWNER_ADDRESS` - which you should set to be your
wallet public address. To do this, you can create a `.env` file in `packages/web`, and set
`STORE_OWNER_ADDRESS` to be your wallet public address in there.

```
STORE_OWNER_ADDRESS=YOUR_PUBLIC_WALLET_ADDRESS
```
