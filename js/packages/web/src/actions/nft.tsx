...
export const mintNFT = async (
  ...
  console.log(`Mint nft with subscriptionConfig ${JSON.stringify(subscriptionConfig)}`);
  ...
  const instructionsAfterArweave: TransactionInstruction[] = [];
  const signersAfterArweave: Keypair[] = [];
  ...
  if (
    ...
    metadataContent.subscriptionConfig = subscriptionConfig;
  }

  console.log(`Metadata content: ${JSON.stringify(metadataContent)}`);
  ...
  instructions.push(...instructionsAfterArweave);
  signers.push(...signersAfterArweave);
  ...
  // console.log(`Arweave result: ${JSON.stringify(result)}; metadata file:`);
